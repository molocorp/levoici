...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('komssa_website', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['komssa.Categorie'])),
            ('nomwebsite', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('urlsiteweb', self.gf('django.db.models.fields.TextField')()),
            ('urlapp', self.gf('django.db.models.fields.TextField')()),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('datecreation', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('komssa', ['Website'])

        # Adding model 'Galerysite'
        db.create_table('komssa_galerysite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('website', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['komssa.Website'])),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('datecreation', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('komssa', ['Galerysite'])

        # Adding model 'Categorie'
        db.create_table('komssa_categorie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pegi', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('datecreation', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('komssa', ['Categorie'])


    def backwards(self, orm):
        # Deleting model 'Website'
        db.delete_table('komssa_website')

        # Deleting model 'Galerysite'
        db.delete_table('komssa_galerysite')

        # Deleting model 'Categorie'
        db.delete_table('komssa_categorie')
